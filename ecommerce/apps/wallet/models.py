...
class Wallet(models.Model):
    user_id=models.OneToOneField(User,related_name='wallet',on_delete=models.CASCADE)
...
class Transaction(models.Model):
    ...
    wallet = models.ForeignKey(Wallet,verbose_name="transactions",on_delete=models.PROTECT)
    ...
    card_pan = models.CharField(max_length=20,verbose_name=_("card pan"),blank=True, null=True)
    hash_card = models.CharField(max_length=190,verbose_name=_("hash card "),blank=True, null=True)
